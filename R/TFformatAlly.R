...
outputBannerTable <- outputBannerTable[-(which(outputBannerTable$`Question ID` >= 149449 & outputBannerTable$`Question ID` <= 149457 & outputBannerTable$Sponsored == 0)), ]
outputBannerTable <- outputBannerTable[-(which(outputBannerTable$`Question ID` >= 215768 & outputBannerTable$`Question ID` <= 215783 & outputBannerTable$Sponsored == 0)), ]
